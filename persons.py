...
panteleev = Person(
    'Пантелееву', 'Константин Анатольевич',
    '''И.о. заместителя начальника управления строительства объектов краевой и
...
sz = Person(
    ...
    'И.о. начальника КГКУ "Служба заказчика Минстроя края"', gender='female')
