...
class Request:
    def __init__(self, date):
        self.date = date
        common_params = {
            'PeriodType': 'day', 'Date': date, 'PageSize': 100
        }

        fkz_params = common_params | {
            'DocumentTypes': '93273da3-3133-4acf-96c2-4adc1ae70e19'
            }

        fz_params = common_params | {
            'DocumentTypes': '82a8bf1c-3bc7-47ed-827f-7affd43a7f27'
            }

        president_params = common_params | {
            'SignatoryAuthorityId':
            '225698f1-cfbc-4e42-9caa-32f9f7403211',
            'DocumentTypes': '0790e34b-784b-4372-884e-3282622a24bd'
            }
        ...
        minfin_params = common_params | {
            ...
            'DocumentTypes': '2dddb344-d3e2-4785-a899-7aa12bd47b6f'
        }
